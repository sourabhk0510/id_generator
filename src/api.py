...
from .block_id_generator import BlockAllocatingDynamoDbIdGenerator
...
def create_app(
	...
	gen = BlockAllocatingDynamoDbIdGenerator(
        ...
        counter_id=counter_id,
        region_name=region_name,
        endpoint_url=endpoint_url,  # optional (use DynamoDB Local if set)
        block_size=10000,             # tune for your latency/throughput
        create_table_if_not_exists=True,
)
